    ...
    <div class="container-fluid">
        ...
        <div class="alert alert-light shadow border-left-warning" role="alert">
            <div class="d-flex align-items-center" href="#">
                ...
                <div>
                    <span class="font-weight-bold text-warning">Tambahkan jadwal baru selama {{ $jum_sanksi->skorsing }} hari, tidak
            ...
            <div class="col-md-12 col-sm-12">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('add.penundaan.skorsing') }}" class="needs-validation" novalidate
                            id="form-tambah">
                            @csrf
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="form-row align-items-end" id="inputRow">
                            ...
                            <div class="form-group px-0">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="" id="invalidCheck"
                                        required>
                                    <label class="form-check-label" for="invalidCheck">Saya sudah menambahkan jadwal matkul
...
@push('script')
    ...
    <script>
        $("#rowAdd").click(function() {
            var html = '';
            html += '<div class="form-row align-items-end" id="inputRow">';
