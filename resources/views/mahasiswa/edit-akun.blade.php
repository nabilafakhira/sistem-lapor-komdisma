        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <form method="POST" action="{{ route('update.akun.mahasiswa') }}" id="formEditMahasiswa">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-right" name="kontak" id="kontak"
                                        value="{{ $user->kontak }}" placeholder="Masukkan nomor WhatsApp" maxlength="15">
                                    <div class="invalid-feedback" id="feedbackkontak"></div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group" id="passwordLama">
                                    ...
                                    <div class="input-group-append">
                                        <div class="input-group-text"><a href=""><i class="fa fa-eye-slash text-secondary " aria-hidden="true"></i></a>
                                        </div>
                                    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#formEditMahasiswa").submit(function(e) {
                ...
                var form = $('#formEditMahasiswa')[0];

                var data = new FormData(form);
                $.ajax({
                    url: "{{ route('validation.edit.akun.mahasiswa') }}",
                    type: 'POST',
                    data: data,
                    processData: false,
                    contentType: false,
            ...
            function removeErrorMsg(msg) {
                ...
                var input = ["username", "email", "oldPassword", "newPassword", "kontak"];
